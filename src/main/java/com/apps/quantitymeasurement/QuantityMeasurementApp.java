...
public class QuantityMeasurementApp {
	...
	public static boolean demonstrateLengthComparasion(double value1, LengthUnit unit1, double value2,
			LengthUnit unit2) {
	...
	// convert the length from one uint to other, overloaded method takes Length
	// object directly
