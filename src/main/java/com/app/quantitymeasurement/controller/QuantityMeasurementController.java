...
public class QuantityMeasurementController {
	...
	public ResponseEntity<QuantityMeasurementDTO> performAdditionWithTargetUnit(
		...
		return ResponseEntity
				.ok(service.add(input.getThisQuantityDTO(), input.getThatQuantityDTO(), input.getTargetQuantityDTO()));
	}
	...
	public ResponseEntity<QuantityMeasurementDTO> performSubtractionWithTargetUnit(
		...
		return ResponseEntity.ok(
				service.subtract(input.getThisQuantityDTO(), input.getThatQuantityDTO(), input.getTargetQuantityDTO()));
	}
